...
namespace Game.Entity {
    public class TestEntity : DrawableEntity {
        ...
        {
            renderer.DrawQuad(this.KinematicBody.Position, this.KinematicBody.Size, this.Sprite.SpriteTexture, this.TexCoords, new Vector4(1.0f, 1.0f, 1.0f, 1.0f), rotation:this.KinematicBody.Rotation);
